...
Если у вас эта же версия или старше - прекрасно. Если младше - значит вы установили слишком старую версию Haskell Platform (непонятно, откуда вы вообще её взяли). На официальном сайте Haskell **обязательно** возьмите новую.
